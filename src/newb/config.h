...
#define NL_DAY_ZENITH_COL    vec3(38/255,175/255,255/255) //#2673ff
#define NL_DAY_HORIZON_COL    vec3(38/255,175/255,255/255) //#87d4ed
...
#define NL_DAWN_ZENITH_COL   vec3(4/255,11/255,26/255) //#040b1a
#define NL_DAWN_HORIZON_COL  vec3(255/255,77/255,77/255) //#ff4d4d
#define NL_DAWN_EDGE_COL     vec3(255/255,102/255,51/255) //#ff6633
...
/* Ore glow intensity */
#define NL_GLOW_TEX 0.4  // 0.4 weak ~ 8.0 bright
...
/* Water */
#define NL_WATER_TRANSPARENCY 0.25 // 0.0 transparent ~ 1.0 normal
...
#define NL_WATER_TINT vec3(133/255,206/255,180/255) //85ceb4
...
#define NL_CLOUD2_THICKNESS 4.25      // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_RAIN_THICKNESS 5 // 0.5 slim ~ 5.0 fat
#define NL_CLOUD2_STEPS 14            // 3 low quality ~ 16 high quality
#define NL_CLOUD2_SCALE 0.001        // 0.003 large ~ 0.3 tiny
